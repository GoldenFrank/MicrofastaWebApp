...
import { useRouter } from 'next/navigation'; // useParams is removed as loanId comes from props
...
interface LoanDetailClientPageProps {
  loanIdFromParams: string;
}

export default function LoanDetailClientPage({ loanIdFromParams }: LoanDetailClientPageProps) {
  const loanId = loanIdFromParams; // Use the prop directly
  ...
  if (!loan) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[calc(100vh-200px)] text-center">
        ...
        <CardDescription className="mb-4">We couldn't find the loan you're looking for. It might be an invalid ID ({loanId || "No ID provided"}) or the loan does not exist.</CardDescription>
